from data.inputs.action_mask_model import TorchActionMaskModel
from data.inputs.IndependentLearnerAll import IndependentLearnerAll
...
class EvaluationAgent():
    ...
    def __init__(self, observation_space, action_space):
        ...
        ppo_agent.restore(checkpoint_path="/data/inputs/model/checkpoint_001750/checkpoint-1750")
